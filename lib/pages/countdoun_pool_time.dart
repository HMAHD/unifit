...
class Pool_Time extends StatefulWidget {
  const Pool_Time({Key? key}) : super(key: key);
  @override
  _Pool_TimeState createState() => _Pool_TimeState();
}

class _Pool_TimeState extends State<Pool_Time> {
  int _counter = 0;
  late Timer _timer;
