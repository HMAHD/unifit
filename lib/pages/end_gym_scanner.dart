...
class EndGymScanner extends StatefulWidget {
  const EndGymScanner({super.key});

  @override
  State<EndGymScanner> createState() => _EndGymScannerState();
}

class _EndGymScannerState extends State<EndGymScanner> {
