...
class EndPoolScanner extends StatefulWidget {
  const EndPoolScanner({super.key});

  @override
  State<EndPoolScanner> createState() => _EndPoolScannerState();
}

class _EndPoolScannerState extends State<EndPoolScanner> {
